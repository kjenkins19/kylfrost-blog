  ...
  return (
    <div className="space-y-4">
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 text-sm">
        ...
        <li>Diplomatic cooperation in team interaction.</li>
        <li>Adherence to established guidelines and procedures.</li>
        <li>Precise, analytical approach to work tasks.</li>
        <li>Logical solutions.</li>
        <li>Consistency of task performance.</li>
        <li>Traditional, quality-oriented work model to follow.</li>
