export const title = "Keys to Managing";
  ...
  return (
    <div className="space-y-4">
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 text-sm">
        ...
        <li>Performance appraisals on a regular basis.</li>
        <li>A manager who prefers quality over quantity</li>
        <li>Be provided opportunities to express and change dysfunctional working conditions</li>
        <li>Help understanding chain of command when there are issues he needs to address. 1</li>
