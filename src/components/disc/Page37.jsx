...
const Page37 = () => {
  return (<div className="space-y-4">
      <p className="text-gray-700 leading-relaxed text-sm">
        ...
        motivators. You will feel energized and successful at work when your job supports
        your personal motivators. They are listed below from the highest to the lowest.
      </p>
      ...
      <div
        ...
        <div className="space-y-6">
          {MOTIVATORS.map((m, idx) => (<div key={m.name} className="space-y-2">
              <div className="flex justify-between items-start gap-4">
                <div>
                  <h3 className="text-md font-bold text-gray-800 flex items-center gap-2">
                    <span
                      className="inline-flex justify-center items-center w-6 h-6 rounded-full bg-indigo-50 text-indigo-600 text-xs font-extrabold">
                      {idx + 1}
                    </span>
                    {m.name}
                  </h3>
