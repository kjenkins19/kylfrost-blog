...
const MEETUPS = [
  { name: "Columbus Ruby Brigade", qrPath: "/meetupList/columbus-ruby.png" },
  { name: "Columbus Elixir", qrPath: "/meetupList/columbus-elixir.png" },
  { name: "Cleveland React", qrPath: "/meetupList/cleveland-react.png" },
  { name: "Chicago JS", qrPath: "/meetupList/chicago-js.png" },
  { name: "Columbus JS", qrPath: "/meetupList/columbus-js.png" },
  { name: "Cleveland Ruby", qrPath: "/meetupList/cleveland-ruby.png" },
  { name: "Chicago Python", qrPath: "/meetupList/chicago-python.png" },
  { name: "Columbus DevOps", qrPath: "/meetupList/columbus-devops.png" },
  { name: "Cleveland Java", qrPath: "/meetupList/cleveland-java.png" },
  { name: "Chicago Elixir", qrPath: "/meetupList/chicago-elixir.png" },
];
          ...
          <tfoot className="print:table-footer-group">
            <tr>
              <td className="w-full pt-8 pb-4 print:pt-4 print:pb-0">
                <footer className="bg-gray-50 p-8 rounded-2xl print:bg-white print:p-4 print:border-2 print:border-gray-100 mb-4 break-inside-avoid">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col items-center flex-shrink-0">
                      <div className="w-32 h-32 bg-white p-2 border border-gray-200 rounded-lg shadow-sm print:w-24 print:h-24 print:shadow-none">
                        <img
